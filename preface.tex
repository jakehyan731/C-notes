...
\IFRU{ядро Linux}{Linux kernel}, \IFRU{ядра линейки Windows NT}{Windows NT OS line kernels}, Oracle RDBMS, \IFRU{и т.д.}{etc}.
...
\IFRU{Денис Юричев ~--- опытный программист и reverse engineer.
Также доступен как преподаватель языка ассемблера, обратной разработки (reverse engineering), Си/Си++.
...
Also available as a freelance teacher of assembly language, reverse engineering, C/C++.
