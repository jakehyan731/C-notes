...
\IFRU{Инициализация это важный момент}{Initialization is important thing}.
...
инициализации}{It is very hard to catch a bug related to not initialized variables accesses.
Compiler will not warn if to use a structure field without initialization}.
