...
\IFRU{Односвязный список}{Single-linked list} ~--- \IFRU{это когда у каждого элемента есть ссылка на следующий}
{it is when each element has pointer to the next one}.
\IFRU{Двусвязный список}{Double-linked list} ~--- \IFRU{когда у элемента есть ссылки на следующий и на предыдущий}
