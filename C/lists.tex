...
\IFRU{Самый легкий для реализации}{Most simple to implement}.
...
\IFRU{Структуру самого первого элемента можно объявлять как локальную
...
можно объявлять указатель на первый элемент списка, 
