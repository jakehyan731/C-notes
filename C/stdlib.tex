...
Собственно, как и исключения в \CPP.
...
\label{goto}
Пофантазируя, можно даже сказать что \TT{longjmp()} это такой супермега-goto, обходящий блоки, ф-ции, 
и восстанавливающий состояние стека.

Однако, нельзя забывать, что всё что восстанавливает \TT{longjmp()} это регистры.
Выделенная память остается выделенной,
никаких деструкторов, как в \CPP, вызвано не будет. Никакого \ac{RAII} здесь нет. 
