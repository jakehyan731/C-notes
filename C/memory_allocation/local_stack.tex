...
{there is no memory allocation happens, it is just stack pointer moving back for $1024$ bytes}
\cite[1.2.3]{REBook}. \IFRU{Это очень быстрая операция}{This is a very fast operation}.
...
what was left there from previous functions execution}.
