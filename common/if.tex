...
\subsubsection{\CPP: \IFRU{объявление переменных в}{variable declarations in} if()}
...
\IFRU{Точно также их можно объявлять и в}{They can be declared in the same way also in} switch().
