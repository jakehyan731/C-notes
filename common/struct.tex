...
\IFRU{В}{In} C99(\ref{C99}) \IFRU{можно инициализировать отдельные поля структур}{it is possible
...
{And even more than that, it is possible to create a structure right in the function arguments, for example}:
